...
// TODO: This is a slightly adjusted clone of https://github.com/Koriit/ktor-logging/blob/master/src/main/kotlin/korrit/kotlin/ktor/features/logging/Logging.kt #173
...
open class Logging(config: Configuration) {
    ...
    protected open fun logPerformance(call: ApplicationCall) {
        ...
        log.info("$duration ms - $status - $method $url")
    }
